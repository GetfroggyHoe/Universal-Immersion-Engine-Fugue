// Standalone mode: scripts/extensions.js import removed
    ...
    try {
        ...
        try {
            ...
            for (let i = 0; i < keys.length; i++) {
                const k = keys[i];
                if (k === "sharedStorage" || k === "chrome") continue;
                let v = null;
