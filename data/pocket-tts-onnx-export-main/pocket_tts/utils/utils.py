...
_ORIGINS_OF_PREDEFINED_VOICES = {
    ...
    "giovanni": "hf://kyutai/tts-voices/predefined/giovanni.wav",
    "lola": "hf://kyutai/tts-voices/predefined/lola.wav",
    "juergen": "hf://kyutai/tts-voices/predefined/juergen.wav",
    "rafael": "hf://kyutai/tts-voices/predefined/rafael.wav",
    "estelle": "hf://kyutai/tts-voices/predefined/estelle.wav",
}
...
PREDEFINED_VOICES = {
    voice_name: f"hf://kyutai/pocket-tts/embeddings_v3/{voice_name}.safetensors"
...
def get_predefined_voice(language: str, name: str) -> str:
    return f"hf://kyutai/pocket-tts/languages/{language}/embeddings/{name}.safetensors"
